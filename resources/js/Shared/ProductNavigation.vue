  ...
  <div class="px-2 max-w-md mx-auto text-gray-800">
    <div class="fixed bottom-0 left-0 z-50 w-full h-14 bg-white border-t border-gray-200">
      <div class="grid h-full max-w-md grid-cols-4 mx-auto font-medium">
        <button
          @click="addToCart"
          class="inline-flex cursor-pointer flex-col items-center justify-center px-5 bg-green-400 group"
        >
          <svg
        ...
        <button
          type="button"
          class="col-span-3 cursor-pointer bg-primary inline-flex flex-col items-center justify-center px-5 group"
        >
